        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">Vehicle Type</h1>
                    <small>Vehicle Type Management</small>
                </div>
            </div>
        </div>
    </div> 
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            ...
                                            <a href="{{route('vehicle_type.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon" data-id="{{$item->id}}" onclick="return window.confirm('Are you sure?')" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('vehicle_type.create')}}" id="create_form" method="post">
                    @csrf
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('vehicle_type.edit')}}" id="edit_form" method="post">
                    @csrf
